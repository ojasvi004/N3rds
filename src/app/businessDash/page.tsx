...
export default function Dashboard() {
  ...
  const transformMonthlyData = (dataArray: MonthlyData[]): { name: string; value: number }[] => {
    ...
    <div className="bg-gray-50 min-h-screen">
      ...
      <div className="p-6">
        ...
        <div className="flex justify-between items-center mb-4">
          ...
          <div className="bg-orange-500 text-white rounded px-3 py-1 text-sm">
            ...
            <tbody>
              {data.churnOverview.map((item, index) => (
                <tr key={index} className="border-t text-gray-700">
                  ...
                  <td className="py-2">{item.percentChange}%</td>
                </tr>
              ))}
            </tbody>
          </table>
